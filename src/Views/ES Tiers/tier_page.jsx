...
const PyramidTier = ({ color, name, height, width, bottom, delay, isHighlighted = false, onClick = null }) => (
    <motion.div 
        className={`absolute left-1/2 transform -translate-x-1/2 ${isHighlighted ? 'z-10' : 'z-0'}`}
...
const Pyramid = ({ highlightTier = null, onTierClick = null }) => (
    <div className="relative h-[350px] w-full mx-auto">
        <PyramidTier name="Iron" color="#4A4A4A" height="50px" width="300px" bottom="0" delay={0.1} isHighlighted={highlightTier === 6} onClick={onTierClick ? () => onTierClick(6) : null} />
        <PyramidTier name="Bronze" color="#AD662F" height="50px" width="260px" bottom="50px" delay={0.2} isHighlighted={highlightTier === 5} onClick={onTierClick ? () => onTierClick(5) : null} />
        <PyramidTier name="Silver" color="#8B8B8B" height="50px" width="220px" bottom="100px" delay={0.3} isHighlighted={highlightTier === 4} onClick={onTierClick ? () => onTierClick(4) : null} />
        <PyramidTier name="Gold" color="#8B4513" height="50px" width="180px" bottom="150px" delay={0.4} isHighlighted={highlightTier === 3} onClick={onTierClick ? () => onTierClick(3) : null} />
        <PyramidTier name="Platinum" color="#4F666A" height="50px" width="140px" bottom="200px" delay={0.5} isHighlighted={highlightTier === 2} onClick={onTierClick ? () => onTierClick(2) : null} />
        <PyramidTier name="Professional" color="#800080" height="50px" width="100px" bottom="250px" delay={0.6} isHighlighted={highlightTier === 1} onClick={onTierClick ? () => onTierClick(1) : null} />
        <PyramidTier name="Legend" color="#FF8C00" height="50px" width="60px" bottom="300px" delay={0.7} isHighlighted={highlightTier === 0} onClick={onTierClick ? () => onTierClick(0) : null} />
    </div>
);
            ...
            content: (
                ...
                >
                    <p className="text-[#E0E0E0]/80 text-lg">
                        Welcome to our ranking system! New players start at level zero, while experienced players receive a rank based on their in-game level.
                    </p>
                    <div className="mt-6">
                        <Pyramid />
                    </div>
                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <p className="text-[#E0E0E0]/80 text-lg mb-4">
                                Experienced players receive a time-based multiplier that affects XP gains and losses:
                            </p>
                            <motion.div 
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p className="text-[#E0E0E0]/90">+(1/10 × multiplier) XP gain</p>
                                </motion.div>
                                <motion.div
                                    className="bg-[#292B35]/80 p-5 rounded-lg border border-[#95C5C5]/30 backdrop-blur-sm"
                                    whileHover={{ scale: 1.02 }}
                        ...
                        <div className="flex items-center justify-center">
                            <Pyramid highlightTier={highlightedTier === null ? 6 : highlightedTier} onTierClick={handleTierClick} />
                        </div>
                    </div>
                    <motion.div
                    ...
                    >
                        <p className="text-center text-[#E0E0E0]/90">
                            <span className="text-[#EE8631] font-semibold">Tip:</span> As you rise through the ranks, your multiplier increases, making each victory more rewarding but each defeat more costly.
                        </p>
                    </motion.div>
                </motion.div>
            )
        },
        {
            ...
            content: (
                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <p className="text-[#E0E0E0]/80 text-lg mb-6">
                                For new players or those with a 1x multiplier, progression is based on:
                            </p>
                            <motion.div 
                            ...
                            >
                                {[
                                    { title: "Match Performance", icon: "🎯", details: "Better scores = more XP" },
                                    { title: "Opponent's Rank", icon: "⚔️", details: "Defeating higher ranks = bonus XP" },
                                    { title: "Tournament Participation", icon: "🏆", details: "Tournament wins multiply XP" },
                                    { title: "Community Engagement", icon: "🤝", details: "Weekly challenges provide XP boosts" }
                                ].map((item, index) => (
                                    <motion.div
                                        key={index}
                                        ...
                                        whileHover={{ scale: 1.05, boxShadow: "0 0 15px rgba(238, 134, 49, 0.3)" }}
                                    >
                                        <div className="text-3xl mb-2">{item.icon}</div>
                                        <h3 className="text-[#EE8631] font-medium text-sm">{item.title}</h3>
                                        <p className="text-[#E0E0E0]/70 text-xs mt-1">{item.details}</p>
                                    </motion.div>
                                ))}
                            </motion.div>
                        </div>
                        <div className="flex items-center justify-center">
                            <Pyramid highlightTier={highlightedTier === null ? 5 : highlightedTier} onTierClick={handleTierClick} />
                        </div>
                    </div>
                    <motion.div
                    ...
                    >
                        <p className="text-center text-[#E0E0E0]/90">
                            <span className="text-[#EE8631] font-semibold">Remember:</span> Consistency is key. Regular participation will help you climb the ranks faster!
                        </p>
                    </motion.div>
                </motion.div>
            )
            ...
            content: (
                ...
                >
                    ...
                    <div className="w-full max-w-xs min-w-[220px]">
                        <h3 className="text-[#EE8631] text-center text-base font-bold mb-1 tracking-wide">Rank XP Requirements</h3>
                        ...
                        <div className="grid grid-cols-3 gap-2 bg-[#23242B]/80 rounded-xl shadow-lg p-2">
                            {[
                                ...
                                >
                                    ...
                                    />
                                    <p className="font-semibold text-xs leading-none text-center" style={{ color: rank.color }}>
                                        {rank.name}
                                    </p>
                                    <p className="text-[#E0E0E0]/80 text-[11px] leading-none text-center">{rank.xp} XP</p>
                                </motion.div>
                            ))}
                        </div>
                        <motion.p 
        ...
        <div className="min-h-screen bg-gradient-to-br from-[#292B35] to-[#1A1B21] py-12 px-6">
            ...
            >
                ...
                <div className="relative">
                            ...
                            return (
                                ...
                                >
                                    <motion.div
                                        ...
                                        transition={{ duration: 0.2 }}
                                    >
                                        <span className="text-white text-sm font-medium">{tier.tier}</span>
                                        {hoveredTier === tier && (
                                            <motion.div
                                                ...
                                                exit={{ opacity: 0, y: 5 }}
                                            >
                                                <h3 className="font-semibold text-lg mb-2" style={{ color: tier.color }}>{tier.name}</h3>
                                                <div className="space-y-2 text-sm">
                                                    <p className="flex justify-between">
                                                        <span className="text-[#E0E0E0]/70">Total Exp Required:</span>
                                                        <span className="font-medium">{tier.expRequired}</span>
                                                    </p>
                                                    <p className="flex justify-between">
                                                        <span className="text-[#E0E0E0]/70">Exp To Reach:</span>
                                                        <span className="font-medium">{expNeeded > 0 ? expNeeded : 0}</span>
                                                    </p>
                                                </div>
                                            </motion.div>
                                        )}
                    ...
                    <div className="absolute top-6 left-0 w-full h-[4px] bg-[#95C5C5]/20 rounded-full">
                        <motion.div
                            initial={{ width: 0 }}
                            animate={{
                                width: `${((tiers.length - 1 - userTier) / (tiers.length - 1)) * 100}%`,
                            }}
                ...
                <div className="text-center mt-12">
                    <motion.button
                        whileHover={{ scale: 1.05, boxShadow: "0 0 25px rgba(238, 134, 49, 0.4)" }}
                        whileTap={{ scale: 0.95 }}
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                {/* Navigation Arrows */}
                                <div className="absolute top-1/2 -translate-y-1/2 w-full flex justify-between" style={{ left: '-2rem', right: '-2rem', width: 'calc(100% + 4rem)' }}>
                                    <motion.button 
                                        onClick={prevSlide}
                                        ...
                                        whileHover={currentSlide !== 0 ? { scale: 1.1, boxShadow: "0 0 15px rgba(238, 134, 49, 0.3)" } : {}}
                                        whileTap={currentSlide !== 0 ? { scale: 0.9 } : {}}
                                    >
                                        <svg className="w-8 h-8 text-[#EE8631]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <motion.button 
                                        onClick={nextSlide}
                                        className={`p-3 rounded-full bg-[#1A1B21]/80 border border-[#95C5C5]/30 hover:bg-[#EE8631]/20 transition-colors z-50 backdrop-blur-sm
                                            ${currentSlide === slides.length - 1 ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}
                                        disabled={currentSlide === slides.length - 1}
                                        whileHover={currentSlide !== slides.length - 1 ? { scale: 1.1, boxShadow: "0 0 15px rgba(238, 134, 49, 0.3)" } : {}}
