  ...
  return (
    <>
      ...
      >
        ...
        {/* Navbar */}
        <div className={`flex justify-around items-center p-2 border-b border-[${primaryAccentColor}]/20`}>
          <button
        ...
        <div className="flex-1 overflow-y-auto p-3 space-y-3">
          {activeTab === 'Notifications' && (
            <>
              ...
              <div className={`bg-[${panelBgColor}]/50 border border-[${secondaryAccentColor}]/30 p-2 rounded text-xs`}>
                <h3 className={`font-semibold text-[${secondaryAccentColor}] mb-0.5`}>Tournament Starting Soon</h3>
                <p className={`text-[${textColor}]/80`}>The Winter Cup starts in 2 hours. Get ready!</p>
              </div>
              <div className={`bg-[${panelBgColor}]/50 border border-[${secondaryAccentColor}]/30 p-2 rounded text-xs`}>
                <h3 className={`font-semibold text-[${secondaryAccentColor}] mb-0.5`}>New Team Registered</h3>
                <p className={`text-[${textColor}]/80`}>Team Phoenix has joined the Summer League.</p>
              </div>
               <div className={`bg-[${panelBgColor}]/50 border border-[${secondaryAccentColor}]/30 p-2 rounded text-xs`}>
                <h3 className={`font-semibold text-[${secondaryAccentColor}] mb-0.5`}>Friend Request</h3>
                <p className={`text-[${textColor}]/80`}>ShadowGamer wants to be your friend.</p>
              </div>
            </>
          )}
          ...
          {activeTab === 'Messages' && (
            <>
              {/* Example Message Items */}
               <div className={`bg-[${panelBgColor}]/50 border border-[${primaryAccentColor}]/30 p-2 rounded text-xs`}>
                <h3 className={`font-semibold text-[${primaryAccentColor}] mb-0.5`}>Team Chat</h3>
                <p className={`text-[${textColor}]/80 truncate`}>AceStriker: Don't forget practice tonight at 8 PM EST!</p>
              </div>
               <div className={`bg-[${panelBgColor}]/50 border border-[${primaryAccentColor}]/30 p-2 rounded text-xs`}>
                <h3 className={`font-semibold text-[${primaryAccentColor}] mb-0.5`}>Coach Mike</h3>
                <p className={`text-[${textColor}]/80 truncate`}>Let's review the VODs tomorrow morning.</p>
              </div>
            </>
          )}
        </div>
