...
import { FaArrowLeft, FaUpload, FaGlobe, FaLock, FaCheck, FaPlus, FaTimes, FaUsers, FaTrophy, FaGamepad, FaFlagCheckered, FaChevronDown, FaChevronRight } from 'react-icons/fa';
    ...
    return (
        <div className="mb-6">
            <div className="flex justify-between items-center mb-3">
                <label className="block text-[#95C5C5] font-medium">Team Milestones</label>
                {!isAdding && (
                    <button 
                    ...
                    {milestones.map(m => (
                        ...
                        >
                            ...
                            <div className="flex-1">
                                ...
                                <div className="text-[#E0E0E0] text-sm">{m.MILESTONE_DESCRIPTION}</div>
            ...
            <AnimatePresence>
                {isAdding && (
                    ...
                    >
                        <div className="mb-3">
                            <label className="block text-xs text-[#95C5C5] mb-1">Milestone Name</label>
                            <input
                                type="text"
                        ...
                        <div className="mb-3">
                            <label className="block text-xs text-[#95C5C5] mb-1">Description (Optional)</label>
                            <input
                                type="text"
                        ...
                        <div className="mb-3">
                            <label className="block text-xs text-[#95C5C5] mb-1">Target Date</label>
                            <input
                                type="date"
        ...
        <div className="mb-6">
            ...
            <AnimatePresence>
                {isAdding && (
                    ...
                    >
                        <div className="mb-3">
                            <label className="block text-xs text-[#95C5C5] mb-1">Member ID</label>
                            <input
                                type="text"
                        ...
                        <div className="mb-3">
                            <label className="block text-xs text-[#95C5C5] mb-1">Access Level</label>
                            <select
...
const CreateTeam = ({ onBackClick }) => {
    ...
    const validateStep = (step) => {
        ...
        switch (step) {
            ...
            case 2: // Team Details
                if (!formData.TEAM_DESCRIPTION) errors.TEAM_DESCRIPTION = "Team description is required";
                if (formData.TEAM_SIZE < 1) errors.TEAM_SIZE = "Team must have at least 1 member";
                break;
    ...
    const SuccessView = () => (
        ...
        >
            ...
            <h2 className="text-2xl font-bold text-[#E0E0E0] mb-4 text-center">Team Created Successfully!</h2>
            ...
            <div className="mb-6 flex items-center bg-[#292B35] p-4 rounded-lg">
                <div className="w-16 h-16 rounded-full bg-[#95C5C5] flex items-center justify-center overflow-hidden mr-4">
                    {formData.TEAM_LOGO ? (
                        ...
                        <span className="text-2xl font-bold text-[#292B35]">{formData.TAG?.slice(0, 2) || "T"}</span>
                    )}
                </div>
                <div>
                    <div className="font-bold text-[#E0E0E0]">{formData.NAME}</div>
                    <div className="text-[#95C5C5]">{formData.TAG} • {formData.GAME}</div>
                    <div className="text-xs text-[#95C5C5] mt-1">Team Size: {formData.TEAM_SIZE}</div>
                </div>
            </div>
            
            <div className="space-y-4 mb-6">
                <div className="bg-[#292B35] p-4 rounded-lg">
                    <h3 className="font-semibold text-[#95C5C5] mb-2">Team Description</h3>
                    ...
                    {formData.MILESTONES.length > 0 ? (
                        <div className="space-y-2">
                            {formData.MILESTONES.map(m => (
                                <div key={m.MILESTONE_ID} className="border-l-2 border-[#EE8631] pl-3">
                                    <div className="font-medium text-[#E0E0E0]">{m.MILESTONE_NAME}</div>
                                    <div className="text-sm text-[#95C5C5]">{m.MILESTONE_DATE}</div>
                                </div>
                            ))}
                        </div>
                    ) : (
            ...
            <div className="flex justify-between items-center">
                {Array.from({ length: totalSteps }).map((_, index) => (
                    <React.Fragment key={index}>
                        ...
                        >
                            {index + 1 <= formStep ? (
                                index + 1 === formStep ? index + 1 : <FaCheck />
                            ) : (
                                index + 1
                            )}
                        </div>
        ...
        switch (formStep) {
            case 1:
                return (
                    ...
                    >
                        <h2 className="text-xl font-bold text-[#95C5C5] mb-6">Team Identity</h2>
                        ...
                        <div className="mb-6">
                            ...
                            <p className="mt-1 text-[#95C5C5] text-sm">Short tag for your team (max 5 characters)</p>
                        </div>
                        ...
                        <div className="mb-6">
                            <label className="block text-[#95C5C5] font-medium mb-2">Team Tagline</label>
                            <input
                                type="text"
                                name="TAGLINE"
                            ...
                            />
                            <p className="mt-1 text-[#95C5C5] text-sm">A short phrase that describes your team's spirit</p>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="flex items-start space-x-4">
                                <div 
                                    className="w-24 h-24 bg-[#292B35] border border-dashed border-[#3A3D4A] rounded-full flex flex-col items-center justify-center overflow-hidden"
                                >
                                    {formData.TEAM_LOGO ? (
                                        <img 
            ...
            case 2:
                return (
                    <motion.div 
                        ...
                        transition={{ duration: 0.3 }}
                    >
                        <h2 className="text-xl font-bold text-[#95C5C5] mb-6">Team Details</h2>
                        ...
                        <div className="mb-6">
                            ...
                            <textarea
                                ...
                                className={`w-full px-4 py-3 bg-[#292B35] border rounded-lg text-[#E0E0E0] min-h-[120px] ${
                                    errors.TEAM_DESCRIPTION ? 'border-red-500' : 'border-[#3A3D4A]'
                                }`}
                                placeholder="Tell us about your team, its focus, goals, and vision..."
                            ></textarea>
                            {errors.TEAM_DESCRIPTION && (
                                <p className="mt-1 text-red-500 text-sm">{errors.TEAM_DESCRIPTION}</p>
                            )}
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <p className="mt-1 text-[#95C5C5] text-sm">Maximum number of team members</p>
                        </div>
                        ...
                        <div className="mb-6">
                            <div className="flex items-center">
                                ...
                                <div className="ml-3">
                                    <label htmlFor="publicTeam" className="text-[#95C5C5] font-medium">
                                        <FaGlobe className="inline mr-2" /> Make this team public
                                    </label>
                                </div>
                            </div>
                            <p className="mt-1 text-[#95C5C5] text-sm ml-7">Public teams are visible to everyone in the platform</p>
                        </div>
                        ...
                        <div className="mb-6">
                            <div className="flex items-center">
                                ...
                                <div className="ml-3">
                                    <label htmlFor="requestJoin" className="text-[#95C5C5] font-medium">
                                        <FaLock className="inline mr-2" /> Require approval for new members
                                    </label>
                                </div>
                            </div>
                            <p className="mt-1 text-[#95C5C5] text-sm ml-7">Team admins need to approve join requests</p>
                        </div>
                    </motion.div>
                );
            ...
            case 3:
                return (
                    <motion.div 
                        ...
                        transition={{ duration: 0.3 }}
                    >
                        <h2 className="text-xl font-bold text-[#95C5C5] mb-6">Team Members & Milestones</h2>
                        
                        <TeamMembersList 
                            members={formData.PARTICIPANTS} 
                            setMembers={(members) => setFormData({ ...formData, PARTICIPANTS: members })} 
                        />
                        
                        <MilestoneInputList 
                            milestones={formData.MILESTONES} 
                            setMilestones={(milestones) => setFormData({ ...formData, MILESTONES: milestones })} 
                        />
                    </motion.div>
                );
            ...
            case 4:
                return (
                    <motion.div 
                        ...
                        transition={{ duration: 0.3 }}
                    >
                        <h2 className="text-xl font-bold text-[#95C5C5] mb-6">Review & Create</h2>
                        ...
                        <div className="bg-[#292B35] p-6 rounded-lg mb-6">
                            <div className="flex items-center mb-4">
                                <div className="w-16 h-16 flex items-center justify-center bg-[#95C5C5] rounded-full text-xl overflow-hidden mr-4">
                                    {formData.TEAM_LOGO ? (
                                        <img src={formData.TEAM_LOGO} alt="logo" className="w-full h-full object-cover" />
                                    ) : (
                                        <span className="font-bold text-[#292B35]">{formData.TAG?.slice(0, 2) || "T"}</span>
                                    )}
                                </div>
                                <div>
                                    <div className="flex items-center">
                                        <h3 className="text-2xl font-bold text-[#E0E0E0]">{formData.NAME}</h3>
                                        <span className="ml-2 px-2 py-1 bg-[#3A3D4A] text-[#95C5C5] rounded text-xs">{formData.TAG}</span>
                                    </div>
                                    <div className="text-[#95C5C5]">{formData.TAGLINE}</div>
                                    <div className="text-sm text-[#95C5C5] mt-1">{formData.GAME}</div>
                                </div>
                            </div>
                            
                            <div className="border-t border-[#3A3D4A] pt-4 mt-4">
                                <h4 className="font-medium text-[#95C5C5] mb-2">Team Description:</h4>
                                <p className="text-[#E0E0E0]">{formData.TEAM_DESCRIPTION}</p>
                            </div>
                            
                            <div className="border-t border-[#3A3D4A] pt-4 mt-4">
                                <h4 className="font-medium text-[#95C5C5] mb-2">Team Size: <span className="text-[#E0E0E0]">{formData.TEAM_SIZE}</span></h4>
                                <h4 className="font-medium text-[#95C5C5] mt-2">Visibility: <span className="text-[#E0E0E0]">{formData.isPublic ? 'Public' : 'Private'}</span></h4>
                                <h4 className="font-medium text-[#95C5C5] mt-2">Member Joining: <span className="text-[#E0E0E0]">{formData.requireApproval ? 'Requires Approval' : 'Open to Join'}</span></h4>
                            </div>
                            
                            <div className="border-t border-[#3A3D4A] pt-4 mt-4">
                                <div className="flex justify-between items-center mb-2">
                                    <h4 className="font-medium text-[#95C5C5]">Team Members:</h4>
                                    <span className="text-sm text-[#95C5C5]">{formData.PARTICIPANTS.length + 1} / {formData.TEAM_SIZE}</span>
                                </div>
                            ...
                            <div className="border-t border-[#3A3D4A] pt-4 mt-4">
                                <h4 className="font-medium text-[#95C5C5] mb-2">Milestones: <span className="text-[#E0E0E0]">{formData.MILESTONES.length}</span></h4>
                                {formData.MILESTONES.length > 0 && (
                                    <div className="bg-[#2F3140] rounded-lg p-2">
                                        {formData.MILESTONES.map((milestone) => (
                                            <div key={milestone.MILESTONE_ID} className="p-2 border-b last:border-b-0 border-[#3A3D4A]">
                                                <div className="font-medium text-[#E0E0E0]">{milestone.MILESTONE_NAME}</div>
                                                <div className="text-xs text-[#95C5C5]">Target: {milestone.MILESTONE_DATE}</div>
                                            </div>
                                        ))}
                                    </div>
                                )}
