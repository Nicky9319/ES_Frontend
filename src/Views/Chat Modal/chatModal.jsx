...
const ChatModal = ({ isOpen, closeModal, message }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      {/* Backdrop (transparent - remove background) */}
      <div className="absolute inset-0" onClick={closeModal}></div>

      <div className="relative h-[600px] top-5 rounded-xl shadow-2xl overflow-hidden transform transition-all duration-300 w-full max-w-3xl bg-[#1e1e24] text-[#dcdcdc] flex flex-col">
        {/* Header */}
        ...
        {/* Chat Body (flex container for messages + input) */}
